...
def _pose(theta, alpha, a, d):
    r11, r12,r13 = cos(theta), -sin(theta)*cos(alpha),sin(theta)*sin(alpha)
...
def rrr_forward_kin(q1, q2, q3, q4, q5, q6):
    X = []
    Y = []
    Z = []
    d90 = pi / 2
    ...
    Y.append(py)
    Z.append(pz)
    T01 = _pose(q1, d90, 0, 0.56)
    T0g = T01
    px, py, pz = T0g[0, 3], T0g[1, 3], T0g[2, 3]
    X.append(px)
    Y.append(py)
    Z.append(pz)
    T12 = _pose(q2, 0, 0.5, 0)
    T0g = T0g * T12
    px, py, pz = T0g[0, 3], T0g[1, 3], T0g[2, 3]
    X.append(px)
    Y.append(py)
    Z.append(pz)
    T23 = _pose(q3, 0, 0.3, 0)
    T0g = T0g * T23
    px, py, pz = T0g[0, 3], T0g[1, 3], T0g[2, 3]
    X.append(px)
    Y.append(py)
    Z.append(pz)
    T34 = _pose(q4, -d90, 0, 0)
    T0g = T0g * T34
    px, py, pz = T0g[0, 3], T0g[1, 3], T0g[2, 3]
    X.append(px)
    Y.append(py)
    Z.append(pz)
    T45 = _pose(q5, d90, 0, 0)
    T0g = T0g * T45
    px, py, pz = T0g[0, 3], T0g[1, 3], T0g[2, 3]
    X.append(px)
    Y.append(py)
...
def create_plot():
  ...
  return fig,ax
def n_update_plot(X,Y,Z,fig,ax):
    ax.cla()
    X = np.reshape(X, (1, 7))
    Y = np.reshape(Y, (1, 7))
    Z = np.reshape(Z, (1, 7))
...
def get_wrist_center(gripper_point, R0g, dg = 0.001):
...
def get_angles(x, y, z, roll, pitch, yaw):
  ...
  T0g_a = Matrix([
    [((sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*cos(q5) + sin(q5)*cos(q1)*cos(q2 + q3))*cos(q6) - (-sin(q1)*cos(q4) + sin(q4)*sin(q2 + q3)*cos(q1))*sin(q6), -((sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*cos(q5) + sin(q5)*cos(q1)*cos(q2 + q3))*sin(q6) + (sin(q1)*cos(q4) - sin(q4)*sin(q2 + q3)*cos(q1))*cos(q6), -(sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*sin(q5) + cos(q1)*cos(q5)*cos(q2 + q3), -0.001*sin(q1)*sin(q4)*sin(q5) + 1.25*sin(q2)*cos(q1) - 0.001*sin(q5)*sin(q2 + q3)*cos(q1)*cos(q4) - 0.054*sin(q2 + q3)*cos(q1) + 0.001*cos(q1)*cos(q5)*cos(q2 + q3) + 1.5*cos(q1)*cos(q2 + q3) + 0.35*cos(q1)],
    [ ((sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*cos(q5) + sin(q1)*sin(q5)*cos(q2 + q3))*cos(q6) - (sin(q1)*sin(q4)*sin(q2 + q3) + cos(q1)*cos(q4))*sin(q6), -((sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*cos(q5) + sin(q1)*sin(q5)*cos(q2 + q3))*sin(q6) - (sin(q1)*sin(q4)*sin(q2 + q3) + cos(q1)*cos(q4))*cos(q6), -(sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*sin(q5) + sin(q1)*cos(q5)*cos(q2 + q3),  1.25*sin(q1)*sin(q2) - 0.001*sin(q1)*sin(q5)*sin(q2 + q3)*cos(q4) - 0.054*sin(q1)*sin(q2 + q3) + 0.001*sin(q1)*cos(q5)*cos(q2 + q3) + 1.5*sin(q1)*cos(q2 + q3) + 0.35*sin(q1) + 0.001*sin(q4)*sin(q5)*cos(q1)],
    [                                                                -(sin(q5)*sin(q2 + q3) - cos(q4)*cos(q5)*cos(q2 + q3))*cos(q6) - sin(q4)*sin(q6)*cos(q2 + q3),                                                                  (sin(q5)*sin(q2 + q3) - cos(q4)*cos(q5)*cos(q2 + q3))*sin(q6) - sin(q4)*cos(q6)*cos(q2 + q3),                                     -sin(q5)*cos(q4)*cos(q2 + q3) - sin(q2 + q3)*cos(q5),                                                                                 -0.001*sin(q5)*cos(q4)*cos(q2 + q3) - 0.001*sin(q2 + q3)*cos(q5) - 1.5*sin(q2 + q3) + 1.25*cos(q2) - 0.054*cos(q2 + q3) + 0.01],
    [                                                                                                                                                            0,                                                                                                                                                             0,                                                                                        0,                                                                                                                                                                                                              1]])
  ...
  wrist_center = get_wrist_center(gripper_point, R0g_eval, dg = 0.001)
